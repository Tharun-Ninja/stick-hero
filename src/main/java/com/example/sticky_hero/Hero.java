...
//        System.out.println(this.hero_image.getY());
    ...
    public void move_horizontal_motion()
    {
        ...
        {
            if (gameController.isCherry_is_present() & gameController.getHero().isWalking() & gameController.checkCollision(hero_image, gameController.getCherry_List().get(0).getCherry_image())) {
        ...
        if (gameController.getHero().isWalking() & gameController.checkCollision(hero_image, gameController.getPlatforms().get(1).getBlock()))
        {
            System.out.println("Game Over");
...
//        System.out.println(this.gameController.getCurrent_stick().getRectangle().getHeight());
        ...
        if ((will_fall)&(length_moved_on_current_bridge>=(this.gameController.getCurrent_stick().getStick_rectangle().getHeight() + gameController.getStandard_stick_width() +3 ) ))
        {
            stopHorizontal_Motion_Animation();
